...
Vagrant.configure("2") do |config|
  ...
  # This command syncs the directory this file is located in with
	# /http/web-control-interface on the guest machine.
  ...
  config.vm.provision :shell, :inline => "apt-get install -q -y g++ make git"

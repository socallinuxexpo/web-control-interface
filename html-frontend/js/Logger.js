 ...
 *          a JQuery element used to print messages
 * @param errorElement -
 *          a JQuery element used to hold errors
 */
var Logger = function(messageElement, errorElement) {
  this.messageElement = messageElement;
  this.errorElement = errorElement;
  this.info("Starting LCARS system.");
};
...
Logger.prototype.info = function(message) {
  this.messageElement.append("<br/><em>[INFO]</em> " + message);
};
...
Logger.prototype.error = function(message) {
  this.errorElement.append("<br/><em>[ERROR]</em> " + message);
};
 ...
 * 
 * @param subsystem -
 *          (optional, usually pre-bound) subsystem to print from
 * @param xhr -
 *          xhr (probably unused)
 * @param text -
 *          error text
...
// Global logger
var GlobalLogger = new Logger($("#messages"), $("#error"));